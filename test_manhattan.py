...
print("\n== Testing 1 Image Manhattan Distance == ")
...
while loop < len(data_test):
    ...
    while i < len(data_train):
        knn.append([
        data_train[i][0], data_train[i][30], round(
                abs(data_train[i][1]      - uji_corel_0) +
                abs(data_train[i][2]     - uji_corel_45) +
                abs(data_train[i][3]     - uji_corel_90) +
                abs(data_train[i][4]    - uji_corel_135) +
                abs(data_train[i][5]       - uji_homo_0) +
                abs(data_train[i][6]      - uji_homo_45) +
                abs(data_train[i][7]      - uji_homo_90) +
                abs(data_train[i][8]     - uji_homo_135) +
                abs(data_train[i][9]     - uji_dissim_0) +
                abs(data_train[i][10]    - uji_dissim_45) +
                abs(data_train[i][11]    - uji_dissim_90) +
                abs(data_train[i][12]   - uji_dissim_135) +
                abs(data_train[i][13]   - uji_contrast_0) +
                abs(data_train[i][14]  - uji_contrast_45) +
                abs(data_train[i][15]  - uji_contrast_90) +
                abs(data_train[i][16] - uji_contrast_135) +
                abs(data_train[i][17]     - uji_energy_0) +
                abs(data_train[i][18]    - uji_energy_45) +
                abs(data_train[i][19]    - uji_energy_90) +
                abs(data_train[i][20]   - uji_energy_135) +
                abs(data_train[i][21]        - uji_asm_0) +
                abs(data_train[i][22]       - uji_asm_45) +
                abs(data_train[i][23]       - uji_asm_90) +
                abs(data_train[i][24]      - uji_asm_135) +
                abs(data_train[i][25]       - uji_metric) +
                abs(data_train[i][26] - uji_eccentricity) +
                abs(data_train[i][27]          - uji_hue) +
                abs(data_train[i][28]   - uji_saturation) +
                abs(data_train[i][29]       - uji_values),4)])
        i += 1    
